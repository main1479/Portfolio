...
- [copy] Resume / CV PDF (`public/Resume_Mainul.pdf`) is significantly behind the site — reads like a 2022 freelancer resume. Critical gaps: no AvsB, no Kemon Doctor, no Radius, no AI-as-co-engineer skills, no full-time positioning, Conversion.com still listed as "Present", "120 projects" vs site's "500+ A/B tests", 6 countries vs site's 9+, and the stale skills list still leans on WordPress/MongoDB/Firebase/Bootstrap. Needs a full rewrite, not a re-sync. See session 2026-05-25 review for the priority-ranked checklist. — `feature/copy-overhaul` session 2026-05-25
- [copy] LinkedIn headline still uses pre-overhaul framing. Sync to "Frontend Developer · A/B Testing & Experimentation · Open to full-time remote & contract" after the CV rewrite lands. — `feature/copy-overhaul` session 2026-05-25
