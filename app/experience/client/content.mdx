export const frontmatter = {
  ...
  endCta: {
    headingLines: [
      { text: "Let's build" },
      { text: 'something', variant: 'outline' },
      { text: 'together.' },
    ],
    sub: "Need a frontend dev who'll turn your design into production code, mobile-first, accessible, and performance-conscious? I'm taking on new freelance work.",
...
A few more aren't listed: short engagements that never made it onto a portfolio page, or clients who'd rather not be named.
