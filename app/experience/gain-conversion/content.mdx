export const frontmatter = {
  ...
  pageDescription:
    '4+ years building production A/B tests for agency clients via Conversion.com — across every major experimentation platform (Optimizely, AB Tasty, Kameleoon, VWO, Adobe Target, Qubit).',
  heroLines: [
  ...
  endCta: {
    headingLines: [
      { text: "Let's ship" },
      { text: 'your next', variant: 'outline' },
      { text: 'test.' },
    ],
    sub: "Hiring a frontend developer with deep A/B-testing experience? Whether it's a single test or a whole programme — I'd like to talk.",
...
- SCSS
- Optimizely, AB Tasty, Kameleoon, VWO, Adobe Target, Qubit
- Browser DevTools
