...
<CaseBlock num="02" label="My role" heading="What I did">
  **Sole developer**, building this over 1.5+ years. A couple of earlier versions were scrapped along the way — early architectural decisions that didn't hold up at the scale the product was growing into. The current iteration spent its full first year on foundation work, on the strength of what those false starts taught me. AI-paired with Claude Code throughout.
