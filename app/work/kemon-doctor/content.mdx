export const frontmatter = {
  ...
  next: { label: 'Next case · 03', title: 'Radius', slug: 'radius' },
...
<CaseVisuals
  items={[
    { caption: 'Homepage + Search',
      src: '/work/kemon-doctor/kemondoctor-01.png',
      alt: 'Kemon Doctor homepage and search results, showing doctor cards with ratings and reviews',
     },
  ]}
/>
...
<CaseVisuals
  items={[
    { caption: 'Doctor detail', src: '/work/kemon-doctor/kemondoctor-02.png', alt: 'Kemon Doctor doctor detail page, showing doctor information and reviews' },
    { caption: 'Review flow', src: '/work/kemon-doctor/kemondoctor-03.png', alt: 'Kemon Doctor review flow' },
  ]}
/>
...
<CaseBlock num="04" label="What I built" heading="The approach">
  ...
  - **Structured reviews**: a small set of strong signals rather than open-text noise.
